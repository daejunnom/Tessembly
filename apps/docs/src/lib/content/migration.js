      ...
      "sections": [
        ...
        },
        {
          ...
          "blocks": [
            ...
            {
              "kind": "note",
              "text": "The 0.3.x implementation defaults to tessembly.rfc3.order.v1. An unlabelled compact string cannot identify its historical profile. Inventory and explicitly migrate old snippets before upgrading. Published 0.1.x artifacts keep their original semantics."
            },
            {
              "kind": "p",
      ...
      "sections": [
        ...
        },
        {
          ...
          "blocks": [
            ...
            {
              "kind": "note",
              "text": "0.3.x 구현의 기본값은 tessembly.rfc3.order.v1입니다. 헤더 없는 단축 문자열에서 과거 버전을 알아낼 수는 없습니다. 저장된 입력의 버전을 확인하고 업그레이드 전에 명시적으로 이관하세요. 공개된 0.1.x 파일의 의미는 그대로입니다."
            },
            {
              "kind": "p",
        ...
        },
        {
          ...
          "blocks": [
            {
              "kind": "p",
              "text": "TSMB/TSDC는 구조 wire=1을 유지하고 의미 바이트=3을 사용합니다. RFC2 문서의 내장 패턴 헤더도 함께 이관합니다. 불투명 선택 메타데이터는 추측하지 않고 MIGRATION_REQUIRES_METADATA_HANDLER로 별도 처리를 요구합니다. 현재 Wasm ABI=3는 이전/새 JS와 Wasm의 혼용을 막습니다."
            },
            {
              "kind": "table",
              "headers": [
