...
console.log(JSON.stringify({name:p.name,version:p.version,dependencies:0,peerDependencies:0,optionalDependencies:0,installHooks:0,wasmImports:0,wasmBytes:bytes.length,packedBytes:result.size,unpackedBytes:result.unpackedSize,files:result.files.map(f=>f.path)},null,2));
